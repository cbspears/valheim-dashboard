...
// Public connect address shown on the Hall + Set Sail page. The join password is
// intentionally NOT here (this site is public) — share it privately in Discord.
...
// version-pinned modpack, paste its code here and the Set Sail page switches to
// the one-click "import this code" flow. Leave '' until then.
