...
export const ALL_MODS: Mod[] = [
  ...
  },
  {
    ...
    version: '10.1.1', // 2026-09-12 10:16: AutoStack multi-player fix + pre-1.0 inventory-row fix; on the box since the morning window (10.1.0 was 2026-09-11 14:02). r2modman installs the newest V+ on every profile update and V+ refuses a client newer than the server, so the box follows every V+ release the same hour. Same cfg schema as 10.0.2.
    category: 'QoL',
    clientRequired: true,
