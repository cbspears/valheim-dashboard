...
#
# Twin of ../eilif-companion-client/refresh-libs.sh (same toolchain, same BepInEx pack).
# EilifPaths reads Heightmap terrain paint + WearNTear material — no Splatform, no HTTP.
set -euo pipefail
...
GAME_DLLS=(assembly_valheim.dll UnityEngine.dll UnityEngine.CoreModule.dll UnityEngine.PhysicsModule.dll)
