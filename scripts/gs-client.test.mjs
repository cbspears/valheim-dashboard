...
// baseline layer re-takes zero-points on every alternation (2026-09-10).
{
  ...
  assert.equal(profileOnly.provenance.craftsSource, 'vh_Crafts', 'crafts ARE taken from the profile (GS sends none on 1.0)');
  assert.equal(profileOnly.itemsCrafted, 4);
